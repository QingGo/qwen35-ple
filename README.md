...
| | NLL | top-1 | 存储 |
|---|---:|---:|---:|
| 四阶计数 n-gram（MKN，**与嫁接同源的 1M token 语料**） | **5.4658** | **24.80%** | **32 MB** |
...
> （数值为字符级去污染切分上的复测；旧切分为 5.3368 / 25.25%，
> 即污染使其虚高了 0.13 nat —— 详见 `docs/round-158-ngram-reference-frame.md` 与本轮复核。）
