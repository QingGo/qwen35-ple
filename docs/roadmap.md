...
## 55. 2026-09-04 第六十九轮：10+ 轮 PLE 路径调研

> 详细见 `docs/round-69-ple-paths-10plus-searches.md`。

### 55.1 确认

- Qwen PLE 原生 2/3-gram；
- 4-gram 需外部构建；
- 2/3-gram 已足够作为 n-gram 记忆主力。

### 55.2 多条路径

训练无关 n-gram LM、代码补全、专名拼写、混合检索 key、约束解码、缓存、训练辅助信号、域适应、长尾记忆、多专家、rerank/审计等。
